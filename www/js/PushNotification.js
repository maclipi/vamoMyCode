angular.module('starter.PushHandler', ['ionic'])

.factory('PushHandler', function($scope, $cordovaPush, $cordovaDialogs, $cordovaMedia, $cordovaToast,Data, ionPlatform, $http, CONSTANT_URL) {
    ...
    function storeDeviceToken(type) {
        ...
        var user = {userid: '80472', device_type: type, orgid:"1377239d-afe1-4695-9bb6-904c3273da88", registration_id: $scope.regId, device_id:(ionic.Platform.device()).uuid};
        console.log("Post token for registered device with data " + JSON.stringify(user));

        $http.post(CONSTANT_URL.SaveDeviceToken, JSON.stringify(user))
